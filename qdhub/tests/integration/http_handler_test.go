...
func setupHTTPTestContext(t *testing.T) (*httpTestContext, func()) {
	...
	syncSvc := impl.NewSyncApplicationService(syncPlanRepo, cronCalculator, nil, dataSourceRepo, dsRepo, workflowExecutor, dependencyResolver, taskEngineAdapter, uowImpl)
