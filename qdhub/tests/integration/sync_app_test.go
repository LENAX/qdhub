...
func TestSyncApplicationService_Integration_CreateAndGetSyncPlan(t *testing.T) {
	...
	svc := impl.NewSyncApplicationService(syncPlanRepo, cronCalculator, nil, dataSourceRepo, dataStoreRepo, workflowExecutor, dependencyResolver, nil, uowImpl, metadataRepo, nil, nil, "", nil)
...
func TestSyncApplicationService_Integration_ExecuteSyncPlan_PassesAPIConfigs(t *testing.T) {
	...
	dataStoreRepo := repository.NewQuantDataStoreRepository(db)
	svc := impl.NewSyncApplicationService(syncPlanRepo, cronCalculator, nil, dataSourceRepo, dataStoreRepo, capturingExecutor, dependencyResolver, nil, uowImpl, metadataRepo, nil, nil, "", nil)
...
func TestSyncApplicationService_Integration_ExecuteSyncPlan_APIConfigsHaveParamKeyAndUpstreamTask(t *testing.T) {
	...
	dataStoreRepo := repository.NewQuantDataStoreRepository(db)
	svc := impl.NewSyncApplicationService(syncPlanRepo, cronCalculator, nil, dataSourceRepo, dataStoreRepo, capturingExecutor, resolverWithMappings, nil, uowImpl, metadataRepo, nil, nil, "", nil)
