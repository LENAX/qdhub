...
func TestWorkflowInstanceRepository_Get(t *testing.T) {
	db, cleanup := setupTestDB(t)
	defer cleanup()
...
func TestWorkflowInstanceRepository_GetByWorkflowDef(t *testing.T) {
	db, cleanup := setupTestDB(t)
	defer cleanup()
	...
	// Get instances by workflow definition
...
func TestWorkflowInstanceRepository_Update(t *testing.T) {
	db, cleanup := setupTestDB(t)
	defer cleanup()
...
func TestWorkflowInstanceRepository_Delete(t *testing.T) {
	db, cleanup := setupTestDB(t)
	defer cleanup()
